...
parser.add_argument('--graph_init', default=None,
...
parser.add_argument('--update_feasibility_every', type=float, default=1,
                    help="Frequency of feasibility scores update in epochs")
