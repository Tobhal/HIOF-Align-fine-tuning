...
def dataset_argparse(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    dataset_parser.add_argument('--save_dir', default=ospj('saved_models'), help='local path to save models')
    ...
    dataset_parser.add_argument('--num_negs', type=int, default=1,
                                help='Number of negatives to sample per positive (triplet loss)')
    dataset_parser.add_argument('--pair_dropout', type=float, default=0.0,
                                help='Each epoch drop this fraction of train pairs')
    dataset_parser.add_argument('--test_set', default='val', help='val|test mode')

    dataset_parser.add_argument('--subset', action='store_true', default=False,
    ...
    dataset_parser.add_argument('--return_images', action='store_true', default=False,
                                help='Return images at the end of the data')
    dataset_parser.add_argument('--augmented', action='store_true', default=False, help='Augment data')
    dataset_parser.add_argument('--open_world', action='store_true', default=False,
                                help='perform open world experiment')
    dataset_parser.add_argument('--add_original_data', action='store_true', default=False,
                                help='Add original data to the dataset')
    ...
    dataloader_parser.add_argument('--shuffled', type=bool, default=True,
                                   help='shuffle the data: true (default) or false')
